...
const ML_LAMBDA_FUNCTION = process.env.ML_LAMBDA_FUNCTION || 'ml-forecasting-lambda';
    ...
    const anomalies = [
      {
        ...
        potential_causes: ["Weekend promotion", "Supply shortage elsewhere", "Seasonal event"],
        recommended_actions: ["Increase stock levels", "Check promotional calendar", "Monitor competitor pricing"]
      },
      {
        id: "anom_002",
        ...
        potential_causes: ["New competitor product", "Price increase", "Seasonal preference shift"],
        recommended_actions: ["Review pricing strategy", "Check product placement", "Monitor customer feedback"]
      },
      {
        id: "anom_003",
        ...
        potential_causes: ["Supplier price increase", "Premium product mix", "Data entry error"],
        recommended_actions: ["Verify pricing accuracy", "Check supplier contracts", "Review product mix"]
      }
    ];
...
export const getAdvancedForecasts = async (req, res) => {
  try {
    ...
    const forecasts = [
      { date: "Jan 16", lstm: 245, arima: 238, ensemble: 242, prophet: 240, actual: 241 },
      { date: "Jan 17", lstm: 252, arima: 245, ensemble: 249, prophet: 247, actual: 248 },
      { date: "Jan 18", lstm: 248, arima: 241, ensemble: 245, prophet: 243, actual: 244 },
      { date: "Jan 19", lstm: 255, arima: 249, ensemble: 252, prophet: 250, actual: 253 },
      { date: "Jan 20", lstm: 260, arima: 253, ensemble: 257, prophet: 255, actual: null },
      { date: "Jan 21", lstm: 262, arima: 255, ensemble: 259, prophet: 257, actual: null },
      { date: "Jan 22", lstm: 265, arima: 258, ensemble: 262, prophet: 260, actual: null },
      { date: "Jan 23", lstm: 268, arima: 261, ensemble: 265, prophet: 263, actual: null },
      { date: "Jan 24", lstm: 270, arima: 264, ensemble: 267, prophet: 265, actual: null },
      { date: "Jan 25", lstm: 272, arima: 266, ensemble: 269, prophet: 267, actual: null }
    ];
    ...
    const insights = [
      {
        ...
        description: "Fruits & Vegetables category showing 18% increase vs last month",
        confidence: 0.94,
        impact: "high",
        category: "Fruits & Vegetables",
        ...
        recommendation: "Increase inventory by 20% for next week to capitalize on demand surge",
      ...
      },
      {
        ...
        description: "LSTM model suggests reducing dairy safety stock by 15% without stockout risk",
        confidence: 0.87,
        impact: "medium",
        category: "Dairy",
        ...
        recommendation: "Implement dynamic safety stock adjustment based on LSTM predictions",
      ...
      },
      {
        ...
        description: "ARIMA model accuracy dropped 3% over last 7 days, retraining recommended",
        confidence: 0.91,
        impact: "medium",
        ...
        recommendation: "Schedule model retraining within 48 hours to maintain prediction quality",
      ...
      },
      {
        ...
        description: "Consumer behavior shows new weekend shopping pattern emerging",
        confidence: 0.82,
        impact: "medium",
        ...
        recommendation: "Adjust weekend staffing and stock allocation to match new pattern",
        action_priority: "medium",
...
export const generateMLForecast = async (req, res) => {
  try {
    ...
    console.log(`Generating ML forecast for store ${storeId} using ${modelType} model`);
    ...
    res.status(200).json(createApiResponse(
      result,
      "ML forecast generated successfully"
    ));
...
export const getModelComparison = async (req, res) => {
  try {
    ...
    const comparison = {
      ...
      analysis: {
        "LSTM": {
          strengths: ["Handles complex patterns", "Good for non-linear trends", "Robust to noise"],
          weaknesses: ["Requires more data", "Longer training time", "Higher resource usage"],
          best_for: ["Complex seasonal patterns", "Non-linear demand", "Large datasets"]
        },
        "ARIMA": {
          strengths: ["Fast training", "Low resource usage", "Good interpretability"],
          weaknesses: ["Assumes linear relationships", "Sensitive to outliers", "Requires stationary data"],
          best_for: ["Linear trends", "Simple seasonality", "Quick forecasts"]
        },
        "Ensemble": {
          strengths: ["Best overall accuracy", "Robust predictions", "Combines model strengths"],
          weaknesses: ["Complex to maintain", "Longer inference time", "Higher computational cost"],
          best_for: ["Production systems", "Critical forecasts", "Maximum accuracy"]
        },
        "Prophet": {
          strengths: ["Handles holidays", "Good with missing data", "Easy to interpret"],
          weaknesses: ["Limited flexibility", "Can overfit", "Slower on large datasets"],
          best_for: ["Business forecasting", "Holiday effects", "Interpretable results"]
        }
      }
    };
